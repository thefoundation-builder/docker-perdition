...
RUN apt-get update && apt-get -y install iproute2 net-tools strace imapproxy perdition curl bash socat openssl && rm -rf /var/lib/apt/archives/*.deb || true && which socat
#&& apt-get -y clean all 
